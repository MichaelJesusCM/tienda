...
$pdf->Cell(5, $textypos, "Tineda On-Line G&G");
$pdf->SetFont('Arial', 'B', 10);
$pdf->setY(30);
$pdf->setX(10);
...
$pdf->setY(35);
$pdf->setX(10);
$pdf->Cell(5, $textypos, "G & G");
$pdf->setY(40);
$pdf->setX(10);
$pdf->Cell(5, $textypos, "00000000");
$pdf->setY(50);
$pdf->setX(10);
$pdf->Cell(5, $textypos, "javix@outlooking.com");
...
$pdf->setY(45);
$pdf->setX(75);
$pdf->Cell(5, $textypos, "$usr");
$pdf->setY(50);
$pdf->setX(75);
$pdf->Cell(5, $textypos, "$nombre@gmail.com");

// Agregamos los datos del cliente
$pdf->SetFont('Arial', 'B', 10);
$pdf->setY(30);
$pdf->setX(135);
$pdf->Cell(5, $textypos, "FACTURA #HD35212Q");
$pdf->SetFont('Arial', '', 10);
$pdf->setY(35);
$pdf->setX(135);
$pdf->Cell(5, $textypos, "Fecha: 24/02/2022");
$pdf->setY(40);
$pdf->setX(135);
$pdf->Cell(5, $textypos, "Vencimiento: 03/04/2022");
$pdf->setY(45);
$pdf->setX(135);
$pdf->Cell(5, $textypos, "");
$pdf->setY(50);
...
$pdf->Ln();
$pdf->Cell(5, $textypos, "Condiciones conceptadas a demanda por falta de incumplimiento.");
